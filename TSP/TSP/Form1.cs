...
namespace TSP
{
    public partial class Form1 : Form
    {
        ...
        {
            inp = TSPGenerator.generateClusters(int.Parse(NodesCount_textBox.Text), int.Parse(clusters_textBox.Text));
            vis.draw(inp);
        }

        private void generateHybrid_button_Click(object sender, EventArgs e)
        {
            inp = TSPGenerator.generateHybrid(int.Parse(NodesCount_textBox.Text), int.Parse(clusters_textBox.Text));
            vis.draw(inp);
        }

        private void ClustersAntiGreedy_button_Click(object sender, EventArgs e)
        {
            inp = TSPGenerator.generateClustersAntiGreedy(int.Parse(NodesCount_textBox.Text), int.Parse(clusters_textBox.Text));
            vis.draw(inp);
        }
